          ...
          {images.slice(1, 3).map((img, i) => (
            ...
            >
              <img
                src={img.src}
                alt={img.alt}
                className="w-full h-[290px] object-cover brightness-105 contrast-105 transition-transform duration-700 group-hover:scale-105"
                loading="lazy"
              />
            </div>
          ))}
          ...
          {images.slice(3).map((img, i) => (
            ...
            >
              <img
                src={img.src}
                alt={img.alt}
                className="w-full h-[200px] md:h-[220px] object-cover brightness-105 contrast-105 transition-transform duration-700 group-hover:scale-105"
                loading="lazy"
              />
            </div>
          ))}
